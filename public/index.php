                ...
                <div id="modal-body-payer" class="modal-body p-5 pt-0">
                    <form id="form-payer-information" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="hidden" class="form-control rounded-3" id="input-nickname" placeholder="Apelido" value='rouadgames'>
                            
                        </div>
                        
                        <!-- quant -->
                        <div class="form-floating mb-3">
                            <input type="hidden" class="form-control rounded-3" id="input-quantid" placeholder="Apelido" value='1000'>
                            
                        </div>
                        
                        <!-- tipo -->
                        <div class="form-floating mb-3">
                            <input type="hidden" class="form-control rounded-3" id="input-tipo" placeholder="Apelido" value='moad'>
                        ...
                        <!-- email -->
                        <div class="form-floating mb-3">
                            <input type="hidden" class="form-control rounded-3" id="input-email" placeholder="name@example.com" value='rouadgames@gmail.com' >
                        ...
                        <div class="input-group input-group-lg mt-1 mb-3">
                            ...
                            <input type="hidden" class="form-control" id="input-valuePayer" placeholder="0,00" value='0,03'>
                        </div>
            ...
            <div class="modal-content rounded-4 shadow">
                ...
                <div id="modal-body-payer" class="modal-body p-5 pt-0">
                    <form id="form-payer-information" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control rounded-3" id="input-nickname" placeholder="Apelido" value='rouadgames'>
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control rounded-3" id="input-email" placeholder="name@example.com" value='rouadgames@gmail.com' >
                        ...
                        <div class="input-group input-group-lg mt-1 mb-3">
                            ...
                            <input type="text" class="form-control" id="input-valuePayer" placeholder="0,00" value='0,03'>
                        </div>

<?php
  ...
  $query = "SELECT id, nickname,quantid, tipo, value FROM donations WHERE id_reference = :external_reference AND status != 'approved'";
  ...
  //Variavel nova busca
  $quantid = $paymentDatabase['quantid'];
  $usuario = $paymentDatabase['nickname'];
  $tipo = $paymentDatabase['tipo'];
  ...
  $valuePayment  = $paymentInfoMercadoPago['transaction_amount']; // Valor da doação.
    ...
    */
    ...
    $sql = "UPDATE fzdsn SET $tipo='$quantid' WHERE username='$usuario'";
